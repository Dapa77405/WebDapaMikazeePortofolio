...
import { FiGithub, FiLinkedin, FiTwitter, FiMail, FiExternalLink, FiDownload, FiPhone, FiChevronDown, FiMenu, FiX, FiCpu, FiZap, FiFeather, FiSliders } from 'react-icons/fi'
import { SiHtml5, SiCss3, SiJavascript, SiTypescript, SiPython, SiReact, SiNextdotjs, SiNodedotjs, SiExpress, SiNestjs, SiTailwindcss, SiFramer, SiRedux, SiVite, SiWebpack, SiGraphql, SiPrisma, SiPostgresql, SiMongodb, SiRedis, SiDocker, SiGit, SiJest, SiVitest, SiPlaywright, SiVercel, SiAmazonaws, SiStorybook } from 'react-icons/si'
...
const projectsData = [
  {
    title: 'Todo App',
    description: 'Task manager sederhana dengan penyimpanan localStorage. CRUD, filter, dan persistensi.',
